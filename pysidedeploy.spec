...
extra_args = --quiet --assume-yes-for-downloads --windows-console-mode=disable --product-name=NetConfigLint --product-version=2.2.0 --file-version=2.2.0 --file-description=NetConfigLint --noinclude-qt-translations --include-data-dir=netconfiglint/gui/qml=netconfiglint/gui/qml --include-data-dir=netconfiglint/gui/i18n=netconfiglint/gui/i18n --include-data-dir=netconfiglint/vendors/huawei/profiles=netconfiglint/vendors/huawei/profiles --include-data-dir=netconfiglint/resources=netconfiglint/resources
